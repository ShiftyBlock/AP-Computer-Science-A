public class DoMath {
    public static void main(String[] args){
        ...
        System.out.println(Calculate.average(100.0, 200.0));
        System.out.println(Calculate.average(100.0, 200.0, 300.0));
        ...
        System.out.println(Calculate.isDivisibleBy(100,4));
        System.out.println(Calculate.absValue(-180.38583242));
        System.out.println(Calculate.max(180, 200.54243423423));
        System.out.println(Calculate.max(23423, -234234, .23422342));
        System.out.println(Calculate.min(1,2));
        System.out.println(Calculate.round2(99.990));
        System.out.println(Calculate.exponent(2.56,2));
        System.out.println(Calculate.factorial(10));
        System.out.println(Calculate.isPrime(50));
        System.out.println(Calculate.gcf(50,0));
        System.out.println(Calculate.sqrt(2.56));
        /*
        exceptions
        System.out.println(Calculate.factorial(-5));
        System.out.println(Calculate.exponent(25, -2));
        System.out.println(Calculate.isDivisibleBy(25, 0));
        System.out.println(Calculate.sqrt(-2.56));
        */
        //back to normal
        System.out.println(Calculate.quadForm(1, 0, -25));
